...
export function AdvancedConfig({
  ...
  return (
    <div className={isThreeTwoOne ? 'mt-0' : 'mt-6'}>
      <button
      ...
      >
        ...
        {isThreeTwoOne ? 'Game Options' : 'Advanced options'}
      </button>

      {expanded && (
        <div className="mt-3 space-y-4">
          {/* Starting hole — wolf and 3-2-1 */}
          {(isWolf || isThreeTwoOne) && (
